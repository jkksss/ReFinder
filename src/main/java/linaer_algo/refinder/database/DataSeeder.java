...
public class DataSeeder {
    ...
    // Temporary main method just so we can run this file directly!
    public static void main(String[] args) {
        System.out.println("Wiping old database records...");
        
        // 1. Force delete all old recipes and ingredients directly through Java
        try (Connection conn = DatabaseConnection.getConnection();
             Statement stmt = conn.createStatement()) {
        ...
        // 2. Run the seeder with your new photo paths!
